                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="#" class="active"><span>Organisation</span> <i
                        ...
                        <ul>
                            ...
                            <li><a href="activite" class="active">Activités</a></li>
            ...
            <div class="heading">
                <div class="container">
                    <div class="row d-flex justify-content-center text-center">
                        <div class="col-lg-8">
                            <h1>Activités de AISOE</h1>
                            <p class="mb-0">Découvrez les différentes activités qui ont lieu au sein de l'organisation
                                AISOE.</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                                <div class="course-item">
                                    ...
                                    <div class="course-content">
                                        ...
                                        <h3><a href="activite-details?id=<?= $homeItems['id']; ?>"><?= $homeItems['titre']; ?></a></h3>
                                        <p class="description"><?= $homeItems['description']; ?></p>
                                        <div class="trainer d-flex justify-content-between align-items-center">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <a href="activite-details?id=<?= $homeItems['id']; ?>" class="category">Lire plus</a>
                                            </div>
