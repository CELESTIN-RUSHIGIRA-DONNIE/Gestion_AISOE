    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="card">
                    <?php
                    $affiche_evenement = "SELECT * FROM evenement WHERE id = " . $_GET['id'];
                    $evenement_run = mysqli_query($con, $affiche_evenement);

                    if (mysqli_num_rows($evenement_run) > 0) {
                        foreach ($evenement_run as $list) {
                    ?>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="student-profile-head">
                                            <div class="profile-bg-img">
                                                <img src="assets/uploads/evenement/<?= $list['photo']; ?>" alt="image événement" class="bg-img">
                                            </div>
