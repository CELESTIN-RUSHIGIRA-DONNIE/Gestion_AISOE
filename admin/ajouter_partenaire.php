                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                ...
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="ajouter_partenaire.php">Liste des Partenaires</a></li>
                                    <li class="breadcrumb-item active">Tous les partenaires</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="page-header">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h3 class="page-title">Partenaires de AISOE</h3>
                                        </div>
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            <a href="partenaire.php" class="btn btn-outline-gray me-2"><i
                                                    class="feather-list"></i></a>
                                            <a href="partenaire.php" class="btn btn-primary"><i
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $affiche_agents = "SELECT * FROM partenaire WHERE status = '1' ORDER BY id DESC";
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td> <a href="details-partenaire.php?id=<?= $list['id']; ?>"
                                                                class="avatar avatar-sm me-2"><img
                                                                    class="avatar-img rounded-circle"
                                                                    src="assets/uploads/partenaire/<?= $list['photo']; ?>"
                                                                    alt="User Image"></a></td>
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="details-partenaire.php?id=<?= $list['id']; ?>"><?= $list['nom'] ?></a>
                                                            </h2>
                                                        </td>
                                                        <td><?= $list['adresse']; ?></td>
                                                        <td class="text-end">
                                                            <div class="actions">
                                                                <a href="details-partenaire.php?id=<?= $list['id']; ?>"
                                                                    class="btn btn-sm bg-success-light me-2 ">
                                                                    <i class="feather-eye"></i>
                                                                </a>
                                                                <a href="edit_partenaire.php?id=<?= $list['id']; ?>" class="btn btn-sm bg-danger-light">
