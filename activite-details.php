...
<head>
    ...
    <title>AISOE - Détails de l'Activité</title>
...
<body class="index-page">
    ...
    <main class="main">
        ...
        if (isset($_GET['id'])) {
            $post_id = $_GET['id'];
            $post = "SELECT * FROM activite WHERE id ='$post_id'";
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="course-header" data-aos="fade-up" data-aos-delay="200">
                                    <div class="course-image">
                                        <img src="admin/assets/uploads/activite/<?= $post_row['photo']; ?>" alt="Course Image" class="img-fluid">
                                    </div>
