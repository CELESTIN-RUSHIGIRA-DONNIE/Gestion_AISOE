            ...
            <div class="heading">
                <div class="container">
                    <div class="row d-flex justify-content-center text-center">
                        <div class="col-lg-8">
                            <h1>Historique</h1>
                            <p class="mb-0">Découvrez l'histoire et les moments clés de AISOE.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6 order-2 order-lg-1 content" data-aos="fade-up" data-aos-delay="200">
                        <h3>Histoire de AISOE</h3>
                        <p class="fst-italic">
                            Est créée à Bukavu dans la province du Sud-Kivu en République Démocratique du Congo, une
                            organisation sans but lucratif dénommée « Aide Sociale Etudiants », AISOE en sigle, à
                            l’initiative de Monsieur BAZIBUHE MUKANIRE Marjolain en date du 3 février 2020 avec la
                            collaboration de Mr MALISAWA MUYUMBA John et Mr Jeans jacques BILUBI PETER.
                        </p>
                        <p>
                            Aide Sociale Etudiants a pour devise : Probité-Inclusivité-Transparence.
                            <strong>Probité :</strong> qualité des membres admis à travailler pour AISOE.<br>
                            <strong>Inclusivité :</strong> tous les étudiants de l’institution où œuvre AISOE, sont
                            d’office membres,
                            peuvent
                            postuler sans exclusion de l’un ou l’autre le voulant pour bénéficier des avantages
                            possibles ou
                            pour contribuer à l’atteinte des objectifs assignés à l’organisation.<br>
                            <strong>Transparence :</strong>clarté dans la gestion des biens, des avoirs.

                        </p>

                        <a href="assets/docs/aisoe-historique.pdf" download class="read-more"><span>Lire le fichier PDF
                            </span> <i class="bi bi-file-earmark-pdf"></i></a>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <ul class="nav nav-tabs flex-column">
                            <li class="nav-item">
                                <a class="nav-link active show" data-bs-toggle="tab" href="#tab-1">Du Siège</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#tab-2">Rayon d’action</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#tab-3">La durée</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#tab-4">Logo</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#tab-5">Buts</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-lg-8 details order-2 order-lg-1">
                                        ...
                                        <p>Aide Sociale Etudiants a son siège à la faculté de Médecine et santé
                                            ...
                                            dans la ville de
                                            Bukavu en province du Sud-Kivu en République Démocratique du Congo.
                                            Ce siège peut être délocalisé selon la nécessité et la décision du Conseil
                                            d’administration.
                                        </p>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-8 details order-2 order-lg-1">
                                        ...
                                        <p>Le champ d’action d’AISOE asbl s’étant sur toutes les institutions
                                            ...
                                            Le champ d’action peut
                                            être prolongé sur décision du Conseil d’Administration. </p>
                                    </div>
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="assets/img/illustration/illustration-11.webp" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab-3">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="assets/img/illustration/illustration-14.webp" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab-4">
                                <div class="row">
                                    <div class="col-lg-8 details order-2 order-lg-1">
                                        <p>A. Forme :
                                            Il s’agit d’un globe terrestre représentant l’Univers (ici l’Université)
                                            dans lequel une main
                                            d’en haut (pouvant s’agir d’un étudiant, un particulier ou un organisme)
                                            tend celle d’en bas
                                            en désespoir (dans le but de secourir).
                                            A gauche du globe, une voyelle « A » en italique symbolisant le désespoir; à
                                            côté duquel,
                                            une voyelle « I » en vertical comme une barre, symbole de secours pour
                                            l’équilibre.
                                            Une ligne horizontale en noire au dessus d’écrit noir signe d’épuisement.
                                        </p>
                                    </div>
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                ...
                                <div class="row">
                                    <div class="col-lg-8 details order-2 order-lg-1">
                                        ...
                                        <p>
                                            ...
                                            ambitieux à risque
                                            d’abandonner les études, de poursuivre jusqu’à achever leur cursus
                                            académique ; et promouvoir
                                            les valeurs socio-culturelles africaines et entrepreneuriales dans notre
                                            champ d’action, ce qui sera
                                            possible par la formation, l’information, la sensibilisation et la
