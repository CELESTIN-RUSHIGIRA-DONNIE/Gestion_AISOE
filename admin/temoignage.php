                    ...
                    <ul>
                        ...
                        <li class="submenu active">
                            ...
                            <ul>
                                ...
                                <li><a href="temoignage.php" class="active">Témoignages</a></li>
                            </ul>
                        </li>
                        <li class="menu-title">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                <h3 class="page-title">Témoignages</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="temoignage.php">Liste des Témoignages</a></li>
                                    <li class="breadcrumb-item active">Tout les témoignages</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="page-header">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h3 class="page-title">Témoignages de nos actions</h3>
                                        </div>
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            <a href="temoignage.php" class="btn btn-outline-gray me-2"><i
                                ...
                                <div class="table-responsive">
                                    <table
                                        ...
                                        <tbody>
                                            <?php
                                            $affiche_agents = "SELECT * FROM temoignage WHERE statut='0' or statut='1' ORDER BY id DESC";
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="details_temoignage.php?id=<?= $list['id']; ?>"
                                                                    class="avatar avatar-sm me-2"><img
                                                                        class="avatar-img rounded-circle"
                                                                        src="assets/uploads/testimonials/<?= $list['photo']; ?>"
                                                                        alt="image Temoin"></a>
                                                            </h2>
                                                        </td>
                                                        <td><?= $list['nom'] ?></td>
                                                        ...
                                                        <td class="text-end">
                                                            <div class="actions">
                                                                ...
                                                                <a href="edit_temoignage.php?id=<?= $list['id']; ?>" class="btn btn-sm bg-danger-light">
                                                ...
                                                ?>
                                                <tr>
                                                    <td colspan="6" class="bg-danger text-white text-center">Pas de témoignage enregistré</td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
