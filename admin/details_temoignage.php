...
<head>
    ...
    <title>AISOE - Temoignage Details</title>
            ...
            <div class="content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                <h3 class="page-title">Detail de Témoignage</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="temoignage.php">Témoignages</a></li>
                                    <li class="breadcrumb-item active">Details de Témoignage</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    if (isset($_GET['id'])) {
                        ...
                        $affiche_agents = "SELECT * FROM temoignage WHERE id = $temoignage_id";
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="about-info">
                                            <h4>Temoignage <span><a href="javascript:;"><i
                                                ...
                                                <div class="col-lg-8 col-md-8">
                                                    <div class="profile-user-box">
                                                        <div class="profile-user-img">
                                                            <img src="assets/uploads/testimonials/<?= $list['photo']; ?>" alt="Profile">
                                                        </div>
                                                ...
                                                <div class="col-lg-4 col-md-4 d-flex align-items-center">
                                                    <div class="follow-btn-group">
                                                        <form action="code.php" method="POST">
                                                            <button type="submit" name="validation_temoignage" value="<?= $list['id']; ?>" class="btn btn-danger follow-btns">Valider</button>
                                                            <button type="submit" name="rejet_temoignage" value="<?= $list['id']; ?>" class="btn btn-info message-btns">Rejeter</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
