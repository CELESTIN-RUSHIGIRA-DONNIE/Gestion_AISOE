      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Contact</h1>
              <p class="mb-0">Pour toute information complémentaire nous concernant, n’hésitez pas à nous contacter.
                Nous serons heureux de vous fournir tous les renseignements dont vous avez besoin.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="contact" class="contact section">
      ...
      <div class="mb-5" data-aos="fade-up" data-aos-delay="200">
        <iframe style="border:0; width: 100%; height: 300px;"
          src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d2146.864098117051!2d28.865881813532827!3d-2.5439293911978913!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x19c2907be44b1149%3A0x61d3f5a02b7eecc9!2sFacult%C3%A9%20de%20MEDECINE%20%2F%20UEA-BUKAVU!5e1!3m2!1sfr!2scd!4v1777659867192!5m2!1sfr!2scd"
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="300">
              ...
              <div>
                <h3>Addresse</h3>
                <p>Université évangelique en afrique / Bukavu</p>
              </div>
            </div><!-- End Info Item -->
            ...
            <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="500">
              ...
              <div>
                <h3>Notre Email </h3>
                <p>aidesocialeetudiantaisoe@gmail.com</p>
              </div>
            </div><!-- End Info Item -->
          ...
          <div class="col-lg-8">
            <form action="traitement.php" method="post">
              <div class="row gy-4">
                ...
                <div class="col-md-12">
                  <textarea class="form-control" name="message" rows="6" placeholder="Ecrivez votre message ici"
                    required=""></textarea>
                </div>

                <div class="col-md-12 text-center">
                  <button type="submit" name="send_message" class="btn btn-danger btn-block">Envoyer le Message</button>
                </div>
              </div>
            </form>
