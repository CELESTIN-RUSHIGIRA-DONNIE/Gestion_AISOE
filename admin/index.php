            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fas fa-graduation-cap"></i> <span>Membres</span> <span class="menu-arrow"></span></a>
                            <ul>
                            ...
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h6>Activités</h6>
                                        <?php
                                        $dash_agents = "SELECT * FROM activite WHERE statut = 1 ";
                                        $dash_agents_run = mysqli_query($con, $dash_agents);
                                        if ($agents_total = mysqli_num_rows($dash_agents_run)) {
                                            echo '<h3>' . $agents_total . '</h3>';
                                        } else {
                            ...
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h6>Evenements</h6>
                                        <?php
                                        $dash_agents = "SELECT * FROM evenement WHERE statut = 1 ";
                                        $dash_agents_run = mysqli_query($con, $dash_agents);
                                        if ($agents_total = mysqli_num_rows($dash_agents_run)) {
                                            echo '<h3>' . $agents_total . '</h3>';
                                        } else {
                            ...
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h6>Abonnés</h6>
                                        <?php
                                        $dash_agents = "SELECT * FROM newslatter WHERE statut = 1 ";
                                        $dash_agents_run = mysqli_query($con, $dash_agents);
                                        if ($agents_total = mysqli_num_rows($dash_agents_run)) {
                                            echo '<h3>' . $agents_total . '</h3>';
                                        } else {
