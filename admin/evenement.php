        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col">
                            <h3 class="page-title">Poster l'Événement </h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="code.php" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea rows="3" cols="3" class="form-control" name="description" placeholder="Enter description"></textarea>
                                            </div>

                                            <div class="form-group">
                                                <label>Contenu : </label>
                                                <textarea rows="5" cols="5" class="form-control" name="contenu" placeholder="Enter message"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Image :</label>
                                    ...
                                    <div class="text-end">
                                        <button type="submit" name="add_evenement" class="btn btn-primary">Valider</button>
                                    </div>
                                </form>
                            </div>
                        </div>
