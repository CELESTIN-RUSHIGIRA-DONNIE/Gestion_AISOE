                            ...
                            <div class="card-body">
                                ...
                                <div class="page-header">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h3 class="page-title">Événements de AISOE</h3>
                                        </div>
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            <a href="liste_evenement.php" class="btn btn-outline-gray me-2"><i
                                                    class="feather-list"></i></a>
                                            <a href="evenement.php" class="btn btn-primary"><i
                                ...
                                <div class="table-responsive">
                                    <table
                                        ...
                                        <tbody>
                                            <?php
                                            $affiche_evenements = "SELECT * FROM evenement ORDER BY id DESC";
                                            $evenements_run = mysqli_query($con, $affiche_evenements);

                                            if (mysqli_num_rows($evenements_run) > 0) {
                                                foreach ($evenements_run as $list) {
                                            ?>
                                                    <tr>
                                                        <td>
                                                            <div class="form-check check-tables">
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="details-evenement.php?id=<?= $list['id']; ?>"
                                                                    class="avatar avatar-sm me-2"><img
                                                                        class="avatar-img rounded-circle"
                                                                        src="assets/uploads/evenement/<?= $list['photo']; ?>"
                                                                        alt="User Image"></a>
                                                            </h2>
                                                        </td>
                                                        <td><?= $list['titre']; ?></td>
                                                        ...
                                                        <td class="text-end">
                                                            <div class="actions">
                                                                ...
                                                                <a href="edit_evenement.php?id=<?= $list['id']; ?>" class="btn btn-sm bg-danger-light">
                                                                    <i class="feather-edit"></i>
                                                                </a>
                                                                <form action="code.php" method="POST">
                                                                    <button type="submit" name="delete_evenement" value="<?= $list['id']; ?>" class="btn btn-sm bg-danger-light">
                                                ...
                                                ?>
                                                <tr>
                                                    <td colspan="6" class="bg-danger text-white text-center">Pas d'événement enregistré</td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
