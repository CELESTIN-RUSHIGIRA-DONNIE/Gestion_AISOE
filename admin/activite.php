        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col">
                            <h3 class="page-title">Poster l'activite </h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="liste_activite.php">Liste des Activités</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="code.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="text-end">
                                        <button type="submit" name="add_activite" class="btn btn-primary">Valider</button>
                                    </div>
                                </form>
                            </div>
                        </div>
