                            ...
                            <div class="card-body">
                                ...
                                ?>
                                        <form action="code.php" method="POST" enctype="multipart/form-data">
                                            <input type="hidden" name="member_id" value="<?= $membre_row['id']; ?>">
                                            <div class="row">
                                                <div class="col-12">
                                                    <h5 class="form-title student-info">Information à modifier <span><a href="javascript:;"><i
                                                                    class="feather-more-vertical"></i></a></span></h5>
                                                </div>
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                        <label>Nom <span class="login-danger">*</span></label>
                                                        <input class="form-control" type="text" value="<?= $membre_row['nom']; ?>" name="first_name" required>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                        <label>Post nom <span class="login-danger">*</span></label>
                                                        <input class="form-control" type="text" value="<?= $membre_row['postnom']; ?>" name="last_name" required>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                        <label>Prenom <span class="login-danger">*</span></label>
                                                        <input class="form-control" type="text" value="<?= $membre_row['prenom']; ?>" name="middle_name" required>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                ...
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                        ...
                                                        <input class="form-control" type="text" value="<?= $membre_row['telephone']; ?>" name="phone_number">
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                        <label>E-Mail <span class="login-danger">*</span></label>
                                                        <input class="form-control" type="text" value="<?= $membre_row['email']; ?>" name="email">
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                        <label>Institution </label>
                                                        <input class="form-control" type="text" value="<?= $membre_row['institution']; ?>" name="institution">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                        <label>Faculté </label>
                                                        <input class="form-control" type="text" value="<?= $membre_row['faculte']; ?>"
                                                            name="faculty">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                        ...
                                                        <input class="form-control" type="text" value="<?= $membre_row['promotion']; ?>"
                                                            name="promotion">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                        ...
                                                        <input class="form-control" type="text" value="<?= $membre_row['etat_civil']; ?>"
                                                ...
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                        ...
                                                        <input class="form-control" type="text" value="<?= $membre_row['profession']; ?>" name="profession">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                        ...
                                                        <input class="form-control" type="text"
                                                            value="<?= $membre_row['adress']; ?>" name="address" required>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group students-up-files">
                                                        ...
                                                        <div class="uplod">
                                                            <label class="file-upload image-upbtn mb-0">
                                                                <input type="hidden" name="old_photo" value="<?= $membre_row['photo']; ?>">
